...
namespace Lesson16.Generics
{
	internal class Program
	{
		static void Main()
		{
			...
			var person1 = new Person("Mike", "Skvortsov", "19");
			var person2 = new Person("Inna", "Skvortsov", "39");
			var person3 = new Person("Sasha", "Skvortsov", "50");
			...
			{
				Console.WriteLine(arr.array[i].FirstName);
			}
			arr.Clear();
			Console.WriteLine(arr.Contains(person1));
		}
